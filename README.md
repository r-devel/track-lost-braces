...
- [check_repo_fixes.R](check_repo_fixes.R) checks the source repositories of packages with lost braces NOTES to identify if the Rd file issues have already been fixed in the default branch of the repository but not yet released to CRAN.
